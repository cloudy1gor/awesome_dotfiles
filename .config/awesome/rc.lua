...
globalkeys = gears.table.join(awful.key({modkey}, "s", hotkeys_popup.show_help),
                              ...
                              awful.key({modkey}, "Tab",
                                        awful.tag.history.restore), awful.key(
                                  {modkey}, "j",
...
clientkeys = gears.table.join(awful.key({modkey}, "f", function(c)
    ...
    c:raise()
end), awful.key({modkey}, "q", function(c) c:kill() end), awful.key(
                                  {modkey, "Control"}, "space",
                                  awful.client.floating.toggle),
                              awful.key({modkey, "Control"}, "Return", function(
    c) c:swap(awful.client.getmaster()) end),
                              awful.key({modkey}, "o",
    ...
    c:raise()
end), awful.key({modkey, "Control"}, "m", function(c)
